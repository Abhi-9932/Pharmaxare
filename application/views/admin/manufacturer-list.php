							...
							<div class="card">
									<div class="card-header">
										<div class="row">
											...
											<div class="col-md-4">
												<h3 class="card-title"><b>Manufacturer List</b></h3><br>
											</div><br>
											<div class="col-sm-2">
											...
											<div class="col-sm-2">
												<a class="btn btn-block btn-danger btn-sm" href="<?php echo base_url();?>index.php/add_manufacturer">
												 Add Manufacturer
												</a>
											</div>
										</div>
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
												...
												<?php $i=1; foreach ($manufacturers as $r){?>
											<tr>
												<td><?=$i;?></td>
												...
												<td class="text-right py-0 align-middle">
												  <div class="btn-group btn-group-sm">
													...
													<a href="<?php echo base_url()?>index.php/admin_controller/delete_manufacturer_list/<?=$r['manufacturer_id'];?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
												  </div>
												</td>
											</tr>
												<?php $i+=1;} ?>
