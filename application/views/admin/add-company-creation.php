						  ...
						  <!-- left column -->
							<div class="col-md-12">
								...
								<div class="card card-primary">
								  ...
								  <!-- /.card-header -->
								  <!-- form start -->
									<form action="<?php echo base_url();?>index.php/admin_controller/add_company_creation_do" method="POST" enctype="multipart/form-data">
										...
										<div class="card-body">
											...
											<div class="row">
												...
												<div class="col-6">
													...
													<input type="tel" class="form-control" id="phno" name="phno" value="">
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-4">
													...
													<textarea type="text" class="form-control" id="address2" name="address2"></textarea>
												</div>
												<div class="col-4">
													<label>Address 3 :</label>
													<textarea type="text" class="form-control" id="address3" name="address3"></textarea>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-6">
													...
													<textarea type="text" class="form-control" id="address4" name="address4"></textarea>
												</div>
												<div class="col-6">
											...
											<div class="row">
												<div class="col-3">
													...
													<input type="text" class="form-control" id="branchcode" name="branchcode" value="">
												</div>
												<div class="col-3">
													<label>Fax No :</label>
												...
												<div class="col-3">
													...
													<input type="text" class="form-control"  id="webadd" name="webadd" value="">
												</div>
												<div class="col-3">
													<label>Email :</label>
											...
											<div class="row">
												<div class="col-6">
													<label>GST IN :</label>
													<input type="text" class="form-control" id="gst" name="gst" value="">
												</div>
												<div class="col-6">
													<label>Date :</label>
											...
											<div class="row">
												<div class="col-6">
													<label>D.L No :</label>
													<input type="text" class="form-control" id="dlno" name="dlno" value="">
												</div>
												<div class="col-6">
													<label>Expiry Date :</label>
													<input type="date" class="form-control" id="expDate1" name="expDate1" value="">
												</div>
											</div>
											...
											<div class="row">
												<div class="col-6">
													...
													<input type="text" class="form-control" id="mfg" name="mfg" value="">
												</div>
												<div class="col-6">
													<label>Expiry Date :</label>
													<input type="date" class="form-control" id="expDate2" name="expDate2" value="">
												</div>
											</div>
											...
											<div class="row">
												<div class="col-6">
													...
													<input type="text" class="form-control" name="service" name="service" value="">
												</div>
												<div class="col-6">
													<label>Expiry Date :</label>
													<input type="date" class="form-control" id="expDate3" name="expDate3" value="">
												</div>
											</div>
											...
											<div class="row">
												<div class="col-6">
													...
													<input type="text" class="form-control" id="foodLic" name="foodLic" value="">
												</div>
												<div class="col-6">
													<label>Expiry Date :</label>
													<input type="date" class="form-control" id="expDate4" name="expDate4" value="">
												</div>
											</div>
											...
											<div class="row">
												<div class="col-6">
													...
													<input type="text" class="form-control" id="Jurisdiction" name="Jurisdiction" value="">
												</div>
												<div class="col-6">
													<label>Country :</label>
											...
											<div class="row">
												...
												<div class="col-6">
													...
													<input type="text" class="form-control" id="financial" name="financial" value="">
												</div>
											</div>
