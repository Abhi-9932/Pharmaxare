								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
											...
											<tbody>
													...
													<?php $i=1; foreach ($medicine_list as $r){?>
												<tr>
													<td><?=$i;?></td>
													<!--<td><?=$r['product_id'];?></td>-->
													<td><?=$r['strength'];?></td>
												...
												<!--	<td><?=$r['medicine_details'];?></td>-->
													...
													<!--<td><?=$r['medicine_type'];?></td>-->
													<td><?=$r['price'];?></td>
													<td><img style="border-radius: 50%;height: 70px;"src="<?php echo base_url();?>tools/upload/<?=$r['image'];?>" ></td>
													<td><?=$r['manufacturer_name'];?></td>
													<td><?=$r['manufacturer_price'];?></td>
												<!--	<td><?=$r['status'];?></td>-->
													...
													<td class="text-right py-0 align-middle">
													  <div class="btn-group btn-group-sm">
														...
														<a href="<?php echo base_url()?>index.php/admin_controller/delete_manufacturer_list" class="btn btn-danger"><i class="fas fa-trash"></i></a>
													  </div>
													</td>
												</tr>
													<?php $i+=1;} ?>
