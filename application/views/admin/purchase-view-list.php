									...
									<!--	    <div class="row forMargin">
									  ...
									  <!-- /.row -->
										...
										<div class="row"> 
											...
											<div class="col-4"> 
												<div class="row forMargin"> <b>Prepared By:</b>&nbsp;&nbsp;<?=$preBy;?></div>
											</div>
											<div class="col-8"> 
												<div class="row forMargin"> <b>Date:</b>&nbsp;&nbsp;<?=$preDate;?></div>
											</div>
											 
											<div class="col-4">
												<div class="row forMargin"> <b>Printed By</b> :&nbsp;&nbsp;<?=$this->session->userdata('username'); ?></div>
											</div>
											<div class="col-8"> 
												<div class="row forMargin"><b>Date</b>:&nbsp;&nbsp; <span id="datetime"></span></div>
											</div>
