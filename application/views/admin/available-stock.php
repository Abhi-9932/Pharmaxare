...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<!-- Sidebar Start -->
			...
			<?php $m="availablestock"; include('includes/admin/sidebar.php'); ?>
							...
							<div class="card">
									<div class="card-header">
										<div class="row">
											...
											<div class="col-md-4">
												<h3 class="card-title"><b>Available Stock</b></h3><br>
											</div><br>
											<div class="col-sm-2">
											...
											<div class="col-sm-2">
												<a class="btn btn-block btn-success btn-sm" href="<?php echo base_url();?>index.php/batchwise_stock_report">
