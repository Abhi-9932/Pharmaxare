...
<div class="wrapper">
	...
	<!-- Sidebar Start -->
		...
		<?php $m="manufacturerledger"; include('includes/admin/sidebar.php'); ?>
									 ...
									 <div class="row">
										<div class="col-12 col-sm-4">
											<div class="form-group">
												<label> Select Manufacturer Name</label>
												<select class="form-control" name="selectcustomername" id="selectcustomername">
