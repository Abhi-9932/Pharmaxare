	...
	<head>
	  ...
	  <title>Manufacturer Payment</title>
	...
	<body class="hold-transition sidebar-mini">
		<div class="wrapper">
			...
			<!-- Sidebar Start -->
				...
				<?php $m="manupayment"; include('includes/admin/sidebar.php'); ?>
					...
					<div class="row mb-2">
					  ...
					  <div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
						  ...
						  <li class="breadcrumb-item active">Manufacturer Payment</li>
						</ol>
					  </div>
					</div>
				  </div>
							...
							<div class="col-md-12">
								...
								<div class="card card-primary">
								  <div class="card-header">
									<h3 class="card-title">Manufacturer Payment</h3>
								  </div>
								  <!-- /.card-header -->
								  <!-- form start -->
											...
											<div class="row">
												<div class="col-6">
													...
													<select class="form-control select2" style="width: 100%;">
														<option selected="selected">selected Manufacturer</option>
