...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<!-- Sidebar Start -->
			...
			<?php $m="paidcustomer"; include('includes/admin/sidebar.php'); ?>
									...
									<!-- <div class="card-header"> -->
										<div class="row">
											...
											<div class="col-md-4 card-header">
												<h3 class="card-title"><b>Paid Customer</b></h3>
											</div>
											...
											<div class="col-sm-2 card-header">
												<a class="btn btn-block btn-danger btn-sm" href="<?php echo base_url();?>index.php/customer_list">
													 Add Customer
												</a>
											</div>
											<div class="col-sm-2 card-header">
												<a class="btn btn-block btn-success btn-sm" href="<?php echo base_url();?>index.php/credit_customer">
													 Customer List
												</a>
											</div>
											<div class="col-sm-2 card-header">
												<a class="btn btn-block btn-primary btn-sm" href="<?php echo base_url();?>index.php/paid_customer">
													Credit Customer
												</a>
											</div>
										</div>
							  ...
							  <!-- /.card-header -->
								<div class="card-body">
									...
									<tbody>
											...
											<?php $i=1; foreach ($paid_customers as $r){?>
										<tr>
											<td><?=$i;?></td>
