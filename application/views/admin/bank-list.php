...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<!-- Sidebar Start -->
			...
			<?php $m="banklist"; include('includes/admin/sidebar.php'); ?>
								...
								<!--	<div class="card-header">-->
									<div class="row">
										...
										<div class="col-md-4 card-header">
											<h3 class="card-title"><b>Bank List</b></h3><br>
										</div>
										...
										<div class="col-sm-2 card-header">
											<a class="btn btn-block btn-success btn-sm" href="<?php echo base_url();?>index.php/add_bank">
												Add Bank
											</a>
										</div>
									</div>
