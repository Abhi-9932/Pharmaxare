	...
	<body class="hold-transition sidebar-mini">
		<div class="wrapper">
			...
			<!-- Sidebar Start -->
				...
				<?php $m="addcategory"; include('includes/admin/sidebar.php'); ?>
					...
					<div class="row mb-2">
					  ...
					  <div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
						  ...
						  <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/lead">Add Category</a></li>
						  ...
						  <!-- left column -->
							<div class="col-md-12">
								...
								<div class="card card-primary">
								  ...
								  <!-- /.card-header -->
								  <!-- form start -->
									<form action="<?php echo base_url();?>index.php/admin_controller/addcategorydo" method="POST">
										<div class="card-body">
											<div class="row">
												<div class="col-md-12">
