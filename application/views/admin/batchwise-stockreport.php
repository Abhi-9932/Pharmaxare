...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<!-- Sidebar Start -->
			...
			<?php $m="b_stockreport"; include('includes/admin/sidebar.php'); ?>
							...
							<div class="card">
									<div class="card-header">
										<div class="row">
											...
											<div class="col-md-4">
												<h3 class="card-title"><b>Stock Report(Batch Wise)</b></h3><br>
											</div><br>
											<div class="col-sm-2">
											...
											<div class="col-sm-2">
												<a class="btn btn-block btn-success btn-sm" href="<?php echo base_url();?>index.php/stock_report">
												 Stock Report
												</a>
											</div>
										</div>
