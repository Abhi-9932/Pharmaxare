...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url(); ?>tools/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>

		<!-- Navbar Start -->

			<?php $m="admindashboard"; include('includes/admin/navbar.php'); ?>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url(); ?>tools/dist/img/user1-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url(); ?>tools/dist/img/user7-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url(); ?>tools/dist/img/user3-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url(); ?>tools/dist/img/user5-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url(); ?>tools/dist/img/user6-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url(); ?>tools/dist/img/user8-128x128.jpg" alt="User Avatar">
