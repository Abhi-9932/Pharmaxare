							...
							<div class="card">
									<div class="card-header">
										<div class="row">
											...
											<div class="col-md-4">
												<h3 class="card-title"><b>Leaf Setting</b></h3><br>
											</div><br>
											<div class="col-sm-2">
											...
											<div class="col-sm-2">
												<a class="btn btn-block btn-danger btn-sm" href="<?php echo base_url();?>index.php/Admin_controller/add_leaf">
												 Add Leaf
												</a>
											</div>
										</div>
							  ...
							  <!-- /.card-header -->
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
												<?php $i=1; foreach ($leafs as $r){?>
											<tr>
												<td><?=$i;?></td>
												<td><?=$r['leaf_type'];?></td>
												<td><?=$r['total_num'];?></td>
												<td class="project-actions">
													<a class="btn btn-info btn-sm" href="<?php echo base_url()?>index.php/admin_controller/edit_leaf_setting">
