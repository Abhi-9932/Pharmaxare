	...
	<body class="hold-transition sidebar-mini">
		<div class="wrapper">
			...
			<!-- Sidebar Start -->
				...
				<?php $m="addmanufacturer"; include('includes/admin/sidebar.php'); ?>
				  ...
				  <div class="container-fluid">
					<div class="row mb-2">
					  ...
					  <div class="col-sm-6">
						...
						<!--  <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/lead">Manufacturer</a></li>-->
						  ...
						  <!-- left column -->
							<div class="col-md-12">
								...
								<div class="card card-primary">
								  ...
								  <!-- /.card-header -->
								  <!-- form start -->
									<form action="<?php echo base_url();?>index.php/admin_controller/addmanufacturerdo" method="POST">
										<div class="card-body">
											<div class="row">
												<div class="col-md-6">
