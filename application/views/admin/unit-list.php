...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<!-- Sidebar Start -->
			...
			<?php $m="unitlist"; include('includes/admin/sidebar.php'); ?>
							...
							<div class="card">
									<div class="card-header">
										<div class="row">
											...
											<div class="col-md-4">
												<h3 class="card-title"><b>Unit List</b></h3><br>
											</div><br>
											<div class="col-sm-2">
											...
											<div class="col-sm-2">
												<a class="btn btn-block btn-danger btn-sm" href="<?php echo base_url();?>index.php/add_unit">
												 Add Unit
												</a>
											</div>
										</div>
							  ...
							  <!-- /.card-header -->
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
												<?php $i=1; foreach ($units as $r){?>
											<tr>
												<td><?=$i;?></td>
												<td><?=$r['unit_name'];?></td>
												<td><?=$r['status'];?></td>
												<td class="project-actions">
													<a class="btn btn-info btn-sm" href="<?php echo base_url()?>index.php/admin_controller/lead_edit">
														  <i class="fas fa-pencil-alt">
														  </i>
														  Edit
													</a>
													<a class="btn btn-danger btn-sm" href="<?php echo base_url()?>index.php/admin_controller/lead_delete">
