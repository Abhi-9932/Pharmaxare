...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<!-- Sidebar Start -->
			...
			<?php $m="categorylist1"; include('includes/admin/sidebar.php'); ?>
							...
							<div class="card">
								<div class="card-header">
									<div class="row">
										...
										<div class="col-sm-2">
											<a class="btn btn-block btn-success btn-sm" data-toggle="modal" data-target="#categoryAdd">
												Add Category
											</a>
										</div>
									</div>
											...
											<tbody>
												...
												<tr>
													...
													<td class="project-actions">
														...
														<a href="<?php echo base_url()?>index.php/admin_controller/edit_category_list/<?=$r['id'];?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
				...
				var user = $('#addcategory').serialize();
					$.ajax({
						...
						success:function(result){
							//console.log(result);
							window.location.replace("<?php echo base_url()?>index.php/admin_controller/category_list1"); 
						}
					});
			});
	...
	$(".delete_data").click(function(){
		var choice = confirm('Do you really want to delete this record?');
			if(choice === true) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url()?>index.php/admin_controller/delete_category_list',
